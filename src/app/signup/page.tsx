      ...
      <div className="w-full max-w-md">
        <div className="glass rounded-2xl p-8 space-y-8 relative overflow-hidden">
          ...
          <div className="relative text-center space-y-2">
            <h1 className="text-3xl font-bold tracking-tight neon-text">Join the Club</h1>
            <p className="text-muted-foreground">Sign up to track your scores, choose your charity, and win the jackpot.</p>
          </div>
