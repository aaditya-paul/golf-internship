    ...
    <div className="min-h-screen bg-background px-4 py-10 sm:py-14">
      <div className="mx-auto max-w-5xl space-y-8 sm:space-y-10">
        ...
        <p className="max-w-3xl text-sm sm:text-base text-muted-foreground leading-relaxed">
          Swing&Win combines monthly competition and charitable giving. You play
          your normal golf rounds, submit scores, and your entries go into the
          monthly draw while a portion of subscription revenue supports charity.
        </p>
        ...
        <section className="glass-panel border border-white/10 rounded-2xl p-5 sm:p-6 space-y-3">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
            <li className="rounded-xl bg-white/5 border border-white/10 p-4">
              Match 5: Jackpot tier
            </li>
            <li className="rounded-xl bg-white/5 border border-white/10 p-4">
              Match 4: Mid-tier payout
            </li>
            <li className="rounded-xl bg-white/5 border border-white/10 p-4">
              Match 3: Entry-tier payout
            </li>
          </ul>
          <p className="text-xs text-muted-foreground">
            Final prize values depend on active subscriptions and the current
            month pool.
          </p>
        </section>
