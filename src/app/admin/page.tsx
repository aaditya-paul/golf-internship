    ...
    <div className="p-4 sm:p-8 space-y-8 animate-in fade-in">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Quick stats and links to manage the system.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link
          href="/admin/users"
          className="glass-panel p-6 rounded-2xl border-white/10 flex items-center gap-4 hover:border-primary/50 transition-colors"
        >
        ...
        >
          ...
          <div>
            ...
            <p className="text-2xl font-bold">
              {activeDraws?.filter((d) => d.status === "pending").length || 0}{" "}
              Pending
            </p>
          </div>
        </Link>
