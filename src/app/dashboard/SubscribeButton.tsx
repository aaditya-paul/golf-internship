    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {plans.map((plan) => (
          ...
          >
            ...
            <div
              className={`flex items-center gap-1.5 text-xs font-semibold mb-1 ${selectedPlan === plan.key ? "text-primary" : "text-muted-foreground"}`}
            >
      ...
      >
        ...
        {loading
          ...
          : `Subscribe — ${selectedPlan === "monthly" ? formatPrice(prices.monthly) + "/mo" : formatPrice(prices.yearly) + "/yr"}`}
      </button>
