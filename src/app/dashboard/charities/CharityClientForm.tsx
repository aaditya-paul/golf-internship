...
export default function CharityClientForm({ currentSettings, charities }: { currentSettings: any, charities: any[] }) {
  const [perc, setPerc] = useState(currentSettings.percentage)
  const [saving, setSaving] = useState(false)
  const [selectedCharityId, setSelectedCharityId] = useState<string>(currentSettings.charityId ?? '')
